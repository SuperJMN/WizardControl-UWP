namespace Wizard
{
    ...
    namespace ComicDesigner.UIUtils
    {
        ...
        public class SetterValueBindingHelper
        {
            ...
            private static FieldInfo GetDPField(string dpName, TypeInfo typeInfo)
            {
                var runtimeFields = typeInfo.AsType().GetRuntimeFields();
                return runtimeFields.First(i => i.Name == dpName + "Property");
            }
